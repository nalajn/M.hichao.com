...
//            }
        ...
        else
        {
            ...
            switch ($tag_sel)
            {
                ...
                case 'insert_hichao_scripts':
                    $t = $this->get_para(substr($tag, 15), 0);

                    return '<?php echo $this->smarty_insert_hichao_scripts(' . $this->make_array($t) . '); ?>';
                    break;
                    
                case 'insert_hichao_css':
                    $t = $this->get_para(substr($tag, 15), 0);

                    return '<?php echo $this->smarty_insert_hichao_css(' . $this->make_array($t) . '); ?>';
                    break;
    ...
    function smarty_insert_hichao_scripts($args)
    {
        static $scripts = array();
    ...
    function smarty_insert_hichao_css($args)
    {
        static $scripts = array();
