...
/***/ function(module, exports, __webpack_require__) {
	...
	var LOGIN = {
	    settings: {
	        ...
	        last: _h5_base2["default"].lang.getUrlParam('last') || '',
	        ...
	        good_data: _h5_base2["default"].lang.getUrlParam('good_data') || window.localStorage.getItem("good_data"),
	        is_payed: _h5_base2["default"].lang.getUrlParam('is_payed'),
	        option_pay_list: _h5_base2["default"].lang.getUrlParam('option_pay_list'),
	        order_type: _h5_base2["default"].lang.getUrlParam('is_payed'),
	        pay_order_amount: _h5_base2["default"].lang.getUrlParam('order_type'),
	        pay_order_id: _h5_base2["default"].lang.getUrlParam('pay_order_id'),
	        pay_order_sn: _h5_base2["default"].lang.getUrlParam('pay_order_sn'),
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        //第三方登录成功跳转的页面
	        var rdUrl = 'http://v1.m.hichao.com/app/templates/' + self.settings.fromUrl + '.html?from=' + last + '&' + $.param(par);
	        ...
	        _cookie2["default"].set('rd', redirectUrl, {
	            path: '/',
	            domain: '.hichao.com'
	        });
	    ...
	    //第三方登录接口
	    linkForAuth: function linkForAuth(auth, that) {
	        var url,
	            local_href,
	            name,
	            self = this;
	        var par = {
	            ...
	            tab_index: self.settings.tab_index,
	            sort: self.settings.sort
	            // rd:'http://v1.m.hichao.com/app/templates/' + self.settings.fromUrl + '.html?' + $.param(par)
	        };
	        ...
	        switch (auth) {
	            ...
	            case 'weixin':
	                ...
	                // var weiRd = 'http://v1.m.hichao.com/app/templates/' + self.settings.fromUrl + '.html?' + $.param(par);
	                //在微信浏览器中打开
	        ...
	        $.ajax({
	            ...
	            success: function success(result) {
	                ...
	                if (result.data) {
	                    ...
	                    _cookie2["default"].set('token', result.data.token, {
	                        path: '/',
	                        domain: '.hichao.com'
	                    });
	                    _cookie2["default"].set('app_uid', result.data.user_id, {
	                        path: "/",
	                        domain: ".hichao.com"
	                    });
	                    _cookie2["default"].set('app_name', result.data.username, {
	                        path: '/',
	                        domain: ".hichao.com"
	                    });
	
	                    var historyUrl = 'http://v1.m.hichao.com/app/templates/' + self.settings.fromUrl + '.html?from=' + last + '&' + $.param(par);
	                    ...
	                    //}
	                        ...
	                        _common2["default"].setDialog(result.message);
	                    }
	            },
