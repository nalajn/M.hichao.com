...
/***/ function(module, exports, __webpack_require__) {
	...
	var _smsbutton = __webpack_require__(9);
	
	var _smsbutton2 = _interopRequireDefault(_smsbutton);
	...
	var REGISTER = {
	    ...
	    bindEvent: function bindEvent() {
	        ...
	        $('.j-for_regBtn').on('tap', function () {
	            var url = self.settings.registerUrl,
	                ...
	                password = $('.J-password').val() || "";
	            if (!_h5_base2["default"].regexp.isMobile(telPhone)) {
	    ...
	    getSMS: function getSMS() {
	        ...
	        if (!_h5_base2["default"].regexp.isMobile(telPhone)) {
	            ...
	            _smsbutton2["default"]({
	                ...
	                sendRequestSms: function sendRequestSms(callback) {
	                    var url = self.settings.sendSmsUrl;
	                    var key = _version2["default"].userkey;
	                    var telPhone = $('.J-username').val() || "";
	                    var data = {
	                        mobile_num: telPhone,
	                        type: 'user_register',
	                        sign: _md52["default"](key + telPhone),
	                        app_name: 'mxyc'
	                    };
	    ...
	    //time: 60//倒计时时间
	    // ajax
	    operate: function operate(url, data, callback) {
	        var self = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	  ...
	  DOTA.prototype = {
	    ...
	    strTimeCount: function strTimeCount(time) {
	  ...
	  var sms_button = function sms_button(configs) {
