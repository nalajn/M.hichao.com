...
/***/ function(module, exports, __webpack_require__) {
	...
	var BRANDDETAIL = {
	    settings: {
	        ...
	        business_id: _h5_base2['default'].lang.getUrlParam('id') || 43,
	    ...
	    scrollAdd: function scrollAdd() {
	        ...
	        $(window).scroll(function () {
	            ...
	            if ($(window).height() + $(window).scrollTop() >= $('body').height() && flag) {
	    ...
	    getData: function getData(sort, index, flag) {
	        var self = this,
	        ...
	        $.ajax({
	            ...
	            success: function success(result) {
	                if (result.response.msg === "success") {
	                    ...
	                    _common2['default'].switchTab($('.tabs'));
	                } else {
	    ...
	    doHtml: function doHtml(data, index) {
	        $("#page_tag_load").hide();
...
/***/ }
/******/ ]);
//# sourceMappingURL=brand_detail.js.map